...
void init_db(AddressDB& addr_db) {
  ...
  addr_db.register_address(Game::PRIME_1, "arm_cannon_matrix", 0x804c10ec, 0x804c502c);
  ...
  addr_db.register_address(Game::PRIME_1, "transform_offset", 0x2c, 0x2c);
  addr_db.register_address(Game::PRIME_1, "tweakplayer", 0x804ddff8, 0x804e1f38);
  ...
  addr_db.register_dynamic_address(Game::PRIME_1, "angular_momentum", "player", {mrp1(0x118)});
  addr_db.register_dynamic_address(Game::PRIME_1, "angular_vel", "player", {mrp1(0x154)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN, "player_xf", "player", {mrp1(0x34)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN, "angular_vel", "player", {rp(0x14c, 0x15c)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN, "air_transitional_friction", "tweak_player", {mrp1(0x180)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN, "freelook_rotation_speed", "tweak_player", {mrp1(0x280)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R1, "player_xf", "player", {mrp1(0x34)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R1, "angular_vel", "player", {mrp1(0x14c)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R1, "air_transitional_friction", "tweak_player", {mrp1(0x180)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R1, "freelook_rotation_speed", "tweak_player", {mrp1(0x280)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R2, "player_xf", "player", {mrp1(0x34)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R2, "angular_vel", "player", {mrp1(0x15c)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R2, "air_transitional_friction", "tweak_player", {mrp1(0x180)});
  addr_db.register_dynamic_address(Game::PRIME_1_GCN_R2, "freelook_rotation_speed", "tweak_player", {mrp1(0x280)});
  ...
  addr_db.register_address(Game::PRIME_2, "transform_offset", 0x20, 0x20);
  ...
  addr_db.register_dynamic_address(Game::PRIME_2, "angular_momentum", "player", {mrp1(0x178)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_2, "armcannon_matrix", "player", {mrp1(0xea8), mrp1(0x3b0)});
  ...
  addr_db.register_address(Game::PRIME_2_GCN, "transform_offset", 0x24, 0x24);
  ...
  addr_db.register_dynamic_address(Game::PRIME_2_GCN, "player_xf", "player", {mrp1(0x24)});
  addr_db.register_dynamic_address(Game::PRIME_2_GCN, "angular_vel", "player", {mrp1(0x1bc)});
  ...
  addr_db.register_address(Game::PRIME_3, "world_id_base", 0x8066fcfc, 0);
  ...
  addr_db.register_dynamic_address(Game::PRIME_3, "angular_momentum", "player", {mrp1(0x174)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_3_STANDALONE, "angular_momentum", "player", {mrp1(0x174)});
  ...
  addr_db.register_dynamic_address(Game::PRIME_3_STANDALONE, "firstperson_pitch", "player", {rp(0x77c, 0x77c)});
  addr_db.register_dynamic_address(Game::PRIME_3_STANDALONE, "powerups_array", "player", {rp(0x35a0, 0x35a0), rp0});
