...
void PrimeWidget::AddDescriptions() {
  ...
  static const char TR_REDUCE_BLOOM[] =
    QT_TR_NOOP("Reduces bloom offset. Upscaling the resolution massively exaggerates the bloom in Prime 3. This option fixes this.");
  static const char TR_BLOOM_INTENSITY[] =
    QT_TR_NOOP("Controls the intensity of the bloom effect in Prime 3. Default value is 100, recommended value is 65, 0 will effectively disable bloom.\n\n"
               "Source: TheHatedGravity and dreamsyntax.");
